...
**設定ファイル**: [`lua/alex/keymaps/init.lua`](https://github.com/peinan/nvim/tree/main/lua/alex/keymaps/init.lua)
...
**設定ファイル**: [`lua/alex/plugins/colorizer.lua`](https://github.com/peinan/nvim/tree/main/lua/alex/plugins/colorizer.lua)
